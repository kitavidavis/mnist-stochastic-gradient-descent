...
A module to implement the stochastic gradient descent learning algorithim
for a feedforward neural network. Gradients are calculated using
backpropagation.
"""
...
class Network(object):
    ...
    def backprop(self, x, y):
        ...
        #feedforward
        activation = x
        activations = [x] # list to store all the activations, leyer by layer
    ...
    def evaluate(self, test_data):
        ...
        correct result. Note that the nueral network's output is assumed to be the index
